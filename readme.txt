...
Tags: push, notifications, notification, android, iphone, ios, push notifications, push notification, push android, notification android, notifications android, iphone notification, iphone notifications, ios notification, ios notifications, chrome notification, firefox notification, safari notification, chrome, safari, telegram
...
> The premium [Push Notifications for WordPress](https://products.delitestudio.com/wordpress/push-notifications-for-wordpress/) also supports Safari, Web Push (Chrome, Firefox, Edge, Opera and others) and Telegram Bot notifications. They work just like mobile notifications, but you don't need to build the apps.
...
> Push Notifications for WordPress (Lite) is our basic solution for small personal blogs. We also offer a full-featured plugin with a reduced memory footprint and unlimited notifications, [Push Notifications for WordPress](https://products.delitestudio.com/wordpress/push-notifications-for-wordpress/), designed for all the other websites. Push Notifications for WordPress also supports Safari, Web Push (Chrome, Firefox, Edge, Opera and others) and Telegram Bot notifications. If you’re not sure which plugin is right for you, compare the features [here](https://products.delitestudio.com/wordpress/push-notifications-for-wordpress/what-are-the-differences-between-push-notifications-for-wordpress-and-push-notifications-for-posts/).
...
**Powerful APIs.** Provides easy to use REST APIs, available via HTTP. Send and receive data using the simple JSON standard. More info [here](https://products.delitestudio.com/wordpress/push-notifications-for-wordpress/documentation/).
...
**Android and iOS libraries.** Save hours of work by using our [Android](https://products.delitestudio.com/wordpress/push-notifications-for-wordpress/push-notifications-library-for-android/) and [iOS](https://products.delitestudio.com/wordpress/push-notifications-for-wordpress/push-notifications-library-for-ios/) libraries in your apps.
...
> WPML is supported only by the premium [Push Notifications for WordPress](https://products.delitestudio.com/wordpress/push-notifications-for-wordpress/).
...
> Custom post types are supported only by the premium [Push Notifications for WordPress](https://products.delitestudio.com/wordpress/push-notifications-for-wordpress/).
...
Yes. We’re a team of mobile developers. We created native [Android](https://products.delitestudio.com/wordpress/push-notifications-for-wordpress/push-notifications-library-for-android/) and [iOS](https://products.delitestudio.com/wordpress/push-notifications-for-wordpress/push-notifications-library-for-ios/) libraries, and we put our expertise to work on custom projects for companies that need great apps. Interested? [Contact us](https://products.delitestudio.com/contact/).

= Getting Started =

Read the [Getting Started guide](https://products.delitestudio.com/wordpress/push-notifications-for-wordpress/documentation/#gettingStarted).

= Detailed documentation =

You can find detailed documentation on the [official website](https://products.delitestudio.com/wordpress/push-notifications-for-wordpress/documentation/).

> The documentation refers to the premium version. Not everything is applicable to the free version. Compare the features [here](https://products.delitestudio.com/wordpress/push-notifications-for-wordpress/what-are-the-differences-between-push-notifications-for-wordpress-and-push-notifications-for-posts/).
...
The Delite Studio team does not provide support for the Push Notifications for WordPress (Lite) plugin on the WordPress.org forums. Ticket support is available to people who bought the premium plugin only. Note that the premium [Push Notifications for WordPress](https://products.delitestudio.com/wordpress/push-notifications-for-wordpress/) has several extra features too, so it might be well worth your investment!
...
> Full FAQs on the [premium plugin's page](https://products.delitestudio.com/wordpress/push-notifications-for-wordpress/faqs/).
...
To send push notifications to iOS devices, you need the Apple Push Notification service SSL certificate in the .PEM format. For more information, see our [Configuring iOS Push Notifications](https://products.delitestudio.com/wordpress/push-notifications-for-wordpress/configuring-ios-push-notifications/) guide.

To send push notifications to Android devices, you need to obtain the Google API Key. For more information, see our [Configuring Android Push Notifications](https://products.delitestudio.com/wordpress/push-notifications-for-wordpress/configuring-android-push-notifications/) guide.
