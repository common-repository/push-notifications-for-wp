...
function pnfw_delete_plugin() {
	...
	$wpdb->query("DELETE FROM $table_name WHERE meta_key = 'pnfw_do_send_push_notifications_for_this_post' OR meta_key = 'pnfw_user_cat';");
	...
	delete_option('pnfw_ios_key_id');
	delete_option('pnfw_ios_team_id');
	delete_option('pnfw_ios_private_key_content');
	delete_option('pnfw_ios_bundle_id');
	...
	delete_option('pnfw_api_oauth_relax');
	...
	delete_option('pnfw_force_badge_count');
