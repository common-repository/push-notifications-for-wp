...
namespace DeliteStudio\FG\ASN1;

use DeliteStudio\FG\ASN1\Exception\ParserException;
use DeliteStudio\FG\ASN1\Universal\BitString;
use DeliteStudio\FG\ASN1\Universal\Boolean;
use DeliteStudio\FG\ASN1\Universal\Enumerated;
use DeliteStudio\FG\ASN1\Universal\GeneralizedTime;
...
use DeliteStudio\FG\ASN1\Universal\RelativeObjectIdentifier;
use DeliteStudio\FG\ASN1\Universal\OctetString;
use DeliteStudio\FG\ASN1\Universal\Sequence;
use DeliteStudio\FG\ASN1\Universal\Set;
use DeliteStudio\FG\ASN1\Universal\UTCTime;
use DeliteStudio\FG\ASN1\Universal\IA5String;
use DeliteStudio\FG\ASN1\Universal\PrintableString;
use DeliteStudio\FG\ASN1\Universal\NumericString;
use DeliteStudio\FG\ASN1\Universal\UTF8String;
use DeliteStudio\FG\ASN1\Universal\UniversalString;
use DeliteStudio\FG\ASN1\Universal\CharacterString;
use DeliteStudio\FG\ASN1\Universal\GeneralString;
use DeliteStudio\FG\ASN1\Universal\VisibleString;
use DeliteStudio\FG\ASN1\Universal\GraphicString;
use DeliteStudio\FG\ASN1\Universal\BMPString;
use DeliteStudio\FG\ASN1\Universal\T61String;
use DeliteStudio\FG\ASN1\Universal\ObjectDescriptor;
use DeliteStudio\FG\Utility\BigInteger;
use LogicException;
...
abstract class ASNObject implements Parsable
{
     ...
     *
     * @return \DeliteStudio\FG\ASN1\ASNObject
     */
