...
use DeliteStudio\FG\ASN1\Exception\NotImplementedException;
...
{
    /**
     * @param string|\DeliteStudio\FG\ASN1\Universal\ObjectIdentifier $objIdentifierString
    ...
    {
        /** @var \DeliteStudio\FG\ASN1\ASNObject $firstObject */
