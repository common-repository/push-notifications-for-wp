...
namespace DeliteStudio\FG\X509\SAN;
...
class IPAddress extends ASNObject implements Parsable
{
    ...
    public static function fromBinary(&$binaryData, &$offsetIndex = 0)
    {
        ...
        if ($contentLength != 4) {
            throw new ParserException("A DeliteStudio\FG\\X509\SAN\IPAddress should have a content length of 4. Extracted length was {$contentLength}", $offsetIndex);
        }
